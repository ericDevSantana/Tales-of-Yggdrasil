    ...
    return (
        <div className={styles.rpg}>
            ...
            <main className={styles.main}>
                <h1>O RPG</h1>
                <p>
                    Tales of Yggdrazil possui um sistema de RPG similar aos clássicos, mas sua mecânica é diferenciada por dar liberdade aos jogadores e mestres criarem seus personagens e histórias únicas. Não existem classes pré-feitas, cada jogador monta a sua própria de acordo com sua estratégia. Os combates são rápidos, utilizando de poucas rolagens de dados.
